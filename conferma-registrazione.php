...
<html lang="it">
    <head>
        <title>Registrazione - Studenti dell'Avogadro</title>
        <meta charset="utf-8">
...
$toinsert = "INSERT INTO utenti
			(nome, classe, mail, telefono, password)
			VALUES
			('$nome', '$classe', '$mail', '$telefono', '$password')";
...
if($result){
	echo("<br><b>Inserimento avvenuto correttamente!</b><br>Ora puoi effettuare il login ed entrare nella tua area personale<br>
    Clicca <a href='/login.php'>QUI</a> per loggarti <i class='fa fa-hand-peace-o' aria-hidden='true'></i>");
} else{
