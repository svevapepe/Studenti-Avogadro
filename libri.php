    ...
    <body>
        ...
        <div class="container">
            <div class="col-sm-8">
                ...
                <p>Cerca nella tabella qui sotto (<a href="#tabella-libri"><i class="fa fa-arrow-down" aria-hidden="true" class="color:black;"></i></a>) i libri che devi comprare<br>
                Se invece vuoi vendere un libro clicca qui<br>
                Per eliminare un libro che hai inserito nella tabella clicca qui</p>
                <h5>Ricorda che per vendere un libro o modificarne i dati devi prima <a href="/registrazione.html">registrarti</a></h5>
                <br>
                <?php
